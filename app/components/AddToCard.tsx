...
export default function AddToCard() {
  ...
  return (
    <div className="relative w-[360px] h-[300px]">
      <div
        className="w-full cursor-pointer  absolute top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/2 hover:h-[300px] group transition-all duration-700 h-[275px] rounded-lg overflow-hidden bg-[#131B25] flex flex-col"
      ...
      >
              ...
              <div className=" absolute inset-0 -translate-x-full w-[200px] duration-1000 transition group-hover:translate-x-0">
                <div className="w-full h-full relative">
                  <img
                    ...
                    src="/card-hover.png"
                  />
                  <div className="absolute inset-0 h-full w-full text-[#F6F6F6] text-[14px] flex gap-x-3 px-5 font-bold flex items-center">
                    <BsBasket3Fill />
        ...
        {/* Footer */}
        <div className="w-full h-[57px] bg-[#212937] flex px-2 justify-between items-center">
